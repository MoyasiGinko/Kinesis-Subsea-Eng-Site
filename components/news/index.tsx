  ...
  const newsItems = [
    {
      ...
      readTime: "5 min read",
      excerpt:
        "Groundbreaking partnership to develop innovative carbon capture solutions for offshore operations, representing a significant step forward in sustainable energy technology.",
      views: 1247,
      featured: true,
    ...
    },
    {
      ...
      readTime: "8 min read",
      excerpt:
        "Comprehensive overview of our environmental initiatives and achievements in sustainable engineering practices across all operational sectors.",
      views: 892,
      featured: false,
    ...
    },
    {
      ...
      readTime: "4 min read",
      excerpt:
        "State-of-the-art facility will drive next-generation subsea technology development and regional expansion initiatives throughout Southeast Asia.",
      views: 654,
      featured: false,
    ...
    },
    {
      ...
      readTime: "6 min read",
      excerpt:
        "Revolutionary artificial intelligence systems now monitor and optimize underwater operations in real-time, improving efficiency by 40%.",
      views: 1156,
      featured: true,
    ...
    },
    {
      ...
      readTime: "7 min read",
      excerpt:
        "Strong performance across all business units drives 23% revenue growth, positioning company for continued expansion in 2024.",
      views: 987,
      featured: false,
      categoryColor: "bg-red-500",
      urgent: false,
    },
    {
      ...
      readTime: "5 min read",
      excerpt:
        "Strategic alliance will accelerate development of offshore renewable energy infrastructure and expand market presence globally.",
      views: 743,
      featured: false,
      categoryColor: "bg-blue-500",
      urgent: false,
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-end">
            <div>
              <h2 className="text-5xl lg:text-6xl font-bold text-slate-900 mb-6 leading-tight">
                NEWS &<span className="block text-slate-600">INSIGHTS</span>
              </h2>
                ...
                <div className="grid lg:grid-cols-2 gap-8 bg-white border-2 border-slate-200 overflow-hidden group hover:border-slate-400 transition-all duration-300">
                  <div className="relative overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4">
                      <span
                        className={`${featured.categoryColor} text-white px-3 py-1 text-xs font-bold uppercase tracking-wide`}
                      >
                        {featured.category}
                      </span>
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className="p-2 border-2 border-slate-200 hover:border-slate-900 hover:text-slate-900 transition-colors duration-300"
                        >
                ...
                <div className="relative flex flex-col h-full bg-white border-2 border-slate-200 overflow-hidden hover:border-slate-400 transition-all duration-300 cursor-pointer">
                  ...
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <div className="absolute top-3 left-3">
                      <span
                        className={`${item.categoryColor} text-white px-2 py-1 text-xs font-bold uppercase tracking-wide`}
                      >
                        {item.category}
                      </span>
                    </div>
                  ...
                  <div className="flex flex-col flex-1 p-6">
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-slate-200">
                      ...
                      <div className="flex gap-1">
                        <button
                          title="Share this article"
                          className="p-1 hover:bg-slate-100 transition-colors duration-300"
                        >
