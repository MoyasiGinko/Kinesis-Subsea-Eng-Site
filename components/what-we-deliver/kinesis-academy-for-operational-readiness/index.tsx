  ...
  return (
    <main className="max-w-7xl mx-auto p-6">
      ...
      <section className="space-y-6 text-lg leading-relaxed text-gray-800">
        ...
        <p>
          We provide comprehensive programs focused on safety, technical skills,
          and operational excellence to prepare individuals for the challenges
        ...
        />
        <p>
          Our academy fosters a culture of continuous learning and innovation,
          ensuring our workforce is equipped to deliver outstanding results.
        </p>
      </section>
    </main>
  );
